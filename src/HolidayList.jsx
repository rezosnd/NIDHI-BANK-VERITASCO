            ...
            <section className="share-parameters-card share-panel" style={{ borderLeft: '4px solid #10b981' }}>
              ...
              <form onSubmit={handleSave} style={{ display: 'flex', alignItems: 'flex-end', gap: '16px', flexWrap: 'wrap' }}>
                ...
                <button type="submit" className="share-button" disabled={isSaving} style={{ height: '42px' }}>
                  {isSaving ? <div style={{ width: "24px", height: "24px", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", margin: "-4px 0" }}><DotLottieReact src="/36038e50-1178-11ee-9eeb-932b0ace7009.lottie" autoplay loop style={{ width: "45px", height: "45px" }} /></div> : 'Save Holiday'}
                </button>
              </form>
            </section>
          )}
